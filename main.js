...
function startpairing(){
    ...
    document.querySelectorAll("img:not(#headerImage):not(#headerToast):not(#headerBacon):not(#total):not(#music-play):not(#music-mute):not(#pic-main):not(#pic-meat):not(#pic-vegetable):not(#pic-fruit):not(#pic-toppings):not(#about-image)").forEach(img => {
        img.style.display = "none";
    });
    ...
    document.getElementById("result").innerHTML = `${totalColories} kcal`;
}

function resetAll(){
    // hide all images
    document.querySelectorAll("img:not(#headerImage):not(#headerToast):not(#headerBacon):not(#music-play):not(#music-mute):not(#pic-main):not(#pic-meat):not(#pic-vegetable):not(#pic-fruit):not(#pic-toppings):not(#about-image):not(#total)").forEach(img => {
        img.style.display = "none";
    });
